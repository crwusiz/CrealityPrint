...
class BooleanOperationJob : public Job
{
public:
            using BoolearOperationCancelCallback   = std::function<bool(Job::Ctl& ctl, JobData&)>;
            using BoolearOperationProcessCallback  = std::function<void(Job::Ctl& ctl, JobData&)>;
